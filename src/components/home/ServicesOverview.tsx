...
/**
 * Sección de resumen de servicios con tarjetas de vidrio oscuro sobre fondo negro.
 */
export function ServicesOverview() {
  return (
    <section className="relative py-24 px-4 sm:px-6 lg:px-8 bg-black overflow-hidden">
      {/* Gradiente radial sutil de resplandor central */}
      ...
      {/* Silueta de auto como marca de agua */}
        ...
        <ScrollReveal>
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-lg text-gray-400 max-w-2xl mx-auto">
              Desde un lavado rápido hasta protección cerámica completa, tenemos el
              paquete adecuado para tu vehículo.
            </p>
          </div>
        </ScrollReveal>
                  ...
                  <ul className="space-y-2.5 mb-8 flex-1">
                    ...
                    {pkg.includedServices.length > 5 && (
                      <li className="text-xs text-gray-500 pl-6">
                        + {pkg.includedServices.length - 5} más incluidos
                      </li>
                    )}
                  </ul>
